...
function App() {
  ...
  function handleSelectSquare(rowIndex, colIndex){
    setGameTurns((prvTurns) => {
      ...
      const updatedTurns = [
        { square: {row: rowIndex, col:colIndex}, player:currentPlayer}, ...prvTurns
      ]
      return updatedTurns
    })
  }
   ...
   <main>
    <div id='game-container'>
      <ol id='players' className='highlight-player'>
       <Players name={PLAYERS.X} symbol='X' isActive={activePlayer === 'X'} onChangeName={handlePlayerNameChange}/>
       <Players name={PLAYERS.O} symbol='O' isActive={activePlayer === 'O'} onChangeName={handlePlayerNameChange}/>
      </ol>
